 ...
 * ```
 */
export declare class MapboxGeocode {
    #private;
    /**
     * The [Mapbox access token](https://docs.mapbox.com/help/glossary/access-token/) to use for all requests.
     */
     ...
     * ```
     */
    forward(searchText: string, optionsArg?: Partial<FetchOptions & GeocodeOptions & PermanentOptions>): Promise<GeocodeResponse>;
    /**
     ...
     * ```
     */
    reverse(lngLat: string | LngLatLike, optionsArg?: Partial<FetchOptions & GeocodeOptions & PermanentOptions>): Promise<GeocodeResponse>;
}
export {};
